...
#        1.0 - io4Master- 27-02-2019 - Modifications
#
# Usage:
...
$NewRootPath = "\\server\packages$\__Retired"
$localcachelocation = "C:\ProgramData\Client\Sources\_Uninstall\"
$localPKGExe = "Uninstall.exe"
$Dummyfolder = "\\serveur\packages$\_UninstallOnly"
...
try
{
	...
	else
	{
        ...
        for ($i=0; $i -lt $DeplName.Count ; $i++)
        {
            ...
            Write-host "Changing folder source to $Dummyfolder"
